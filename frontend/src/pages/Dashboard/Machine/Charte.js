        ...
        switch (groupe) {
          case "A":
            if (posts[o] && posts[o].value[1] === "0") {
              const objectExists = filtered.some(
                (item) =>
                  item.poste === posts[o].value &&
                  item.tauxTRS === posts[o].taux
              );
              if (!objectExists) {
                aux.push(posts[o]);
              }
          ...
          default:
            const objectExists = filtered.some(
              (item) =>
                item.poste === posts[o].poste && item.tauxTRS === posts[o].taux
            );
            if (!objectExists) {
      ...
      return (
        <div className="custom-tooltip">
          <p className="Poste">
            <span
              style={{ color: "white" }}
            >{`Poste: ${payload[0].payload.value}`}</span>
          </p>
          <p className="Taux">
            <span style={{ color: "white" }}>{`Taux: ${(
              Number(payload[0].payload.taux) * 100
            ).toFixed(2)}%`}</span>
          </p>
        </div>
      );
    ...
    if (active && payload && payload.length) {
      return (
        <div className="custom-tooltip1">
          ...
          <p className="Taux">
            <span style={{ color: "white" }}>{`Taux: ${(
              Number(payload[0].payload.tauxProductivite) * 100
            ).toFixed(2)}%`}</span>
          </p>
        </div>
      );
    ...
    <>
      <div className="parent-container">
        <div className="collapsible-taux">
          <div className="header-chart">Taux de rendement synthétique</div>
        ...
        <div className="container">
          ...
          <div className="filter-component">
            ...
            <div
              className={`content ${isFilterCollapsed ? "" : "show-content"}`}
            >
              <div className="column">
                <div className="parent1">
                  <div
                    className="choice"
                    onClick={() => handleDialogOpen1("seance")}
                  >
                    Séance
                  </div>
                  <div
                    className="choice"
                    onClick={() => handleDialogOpen2("day")}
                  >
                    Jour
                  </div>
                  <div
                    className="choice"
                    onClick={() => handleDialogOpen3("week")}
                  >
                    Semaine
                  </div>
                  <div
                    className="choice"
                    onClick={() => handleDialogOpen4("month")}
                  >
                    Mois
                  </div>
                  <div
                    className="choice"
                    onClick={() => handleDialogOpen5("quarter")}
                  >
                    Trimestre
                  </div>
                </div>
                ...
                <Dialog
                  ...
                  open={dialogOpen1}
                  PaperProps={{ style: { width: "18%", height: "23%" } }}
                >
                ...
                <Dialog
                  ...
                  open={dialogOpen2}
                  PaperProps={{ style: { width: "22%", height: "57%" } }}
                >
                ...
                <Dialog
                  ...
                  open={dialogOpen3}
                  PaperProps={{ style: { width: "22%", height: "60%" } }}
                >
                ...
                <Dialog
                  ...
                  open={dialogOpen4}
                  PaperProps={{ style: { width: "20%", height: "44%" } }}
                >
                ...
                <Dialog
                  ...
                  open={dialogOpen5}
                  PaperProps={{ style: { width: "18%", height: "54%" } }}
                >
          ...
          <div className="search-component">
            <div className="collapsible-box1">
              ...
              <div
                className={`content ${isSearchCollapsed ? "" : "show-content"}`}
              >
                ...
                <div className="checkcontainer">
                  <div className="checkboxdiv">
                    <input
                      type="checkbox"
                      ref={checkboxRefA}
                      onChange={(event) => handleChangeGroupe(event, "A")}
                    />
                    A(0..99)
                  </div>
                  <div className="checkboxdiv">
                    <input
                      type="checkbox"
                      ref={checkboxRefB}
                      onChange={(event) => handleChangeGroupe(event, "B")}
                    />
                    B(100..199)
                  </div>
                  <div className="checkboxdiv">
                    <input
                      type="checkbox"
                      ref={checkboxRefC}
                      onChange={(event) => handleChangeGroupe(event, "C")}
                    />
                    C(200..299)
                  </div>
                  <div className="checkboxdiv">
                    <input
                      type="checkbox"
                      ref={checkboxRefD}
                      onChange={(event) => handleChangeGroupe(event, "D")}
                    />
                    D(300..399)
                  </div>
                </div>
      ...
      <div className="grid-container">
        <div className="item">
          <div className="collapsible-boxtaux cbtd">
            <div className="headertaux ctd">Taux de performance</div>
            <div className="show-content">
              <div className="row">
                <div className="parenttrs">
        ...
        <div className="item">
          <div className="collapsible-boxtaux cbtd1">
            <div className="headertaux ctd1">Taux de qualité</div>
            <div className="show-content">
              <div className="row">
                <div className="parenttrs">
                  <div className="insidetaux">
                    <ResponsiveContainer width={"100%"} height={"99%"}>
                      <AreaChart
                        ...
                        height={250}
                        data={
                          Object.keys(fetchedData1).length === 0
                            ? Tq1
                            : fetchedData1
                        }
                        margin={{
        ...
        <div className="item">
          <div className="collapsible-boxtaux cbtd2">
            <div className="headertaux ctd2">Taux de rendement globale</div>
            <div className="show-content">
              <div className="row">
                <div className="parenttrs">
                  <div className="insidetaux">
                    <ResponsiveContainer width={"100%"} height={"99%"}>
                      <AreaChart
                        ...
                        height={250}
                        data={
                          Object.keys(fetchedData2).length === 0
                            ? Trg
                            : fetchedData2
                        }
                        margin={{
        ...
        <div className="item">
          <div className="collapsible-boxtaux cbtd3">
            <div className="headertaux ctd3">Taux de rendement économique</div>
            <div className="show-content">
              <div className="row">
                <div className="parenttrs">
                  <div className="insidetaux">
                    <ResponsiveContainer width={"100%"} height={"99%"}>
                      <AreaChart
                        ...
                        height={250}
                        data={
                          Object.keys(fetchedData3).length === 0
                            ? Tre
                            : fetchedData3
                        }
                        margin={{
